...
curl https://raw.githubusercontent.com/powerline/fonts/blob/master/SourceCodePro/Source%20Code%20Pro%20for%20Powerline.otf > "Source Code Pro for Powerline.otf"
